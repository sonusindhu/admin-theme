...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <link href="{{ URL::asset('admin/plugins/bower_components/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
        <!--/ END GLOBAL MANDATORY STYLES -->

        <!-- START @PAGE LEVEL STYLES -->
        <link href="{{ URL::asset('admin/plugins/bower_components/fontawesome/css/font-awesome.min.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/plugins/bower_components/animate.css/animate.min.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/plugins/bower_components/dropzone/downloads/css/dropzone.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/plugins/bower_components/jquery.gritter/css/jquery.gritter.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/plugins/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css')}}" rel="stylesheet">
        <!--/ END PAGE LEVEL STYLES -->

        <!-- START @THEME STYLES -->
        <link href="{{ URL::asset('admin/css/reset.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/css/layout.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/css/components.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/ss/plugins.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/ss/themes/default.theme.css')}}" rel="stylesheet" id="theme">
    ...
    <body class="page-session page-sound page-header-fixed page-sidebar-fixed demo-dashboard-session">
                        ...
                        <li id="tour-6" class="dropdown navbar-profile">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="meta">
                                    ...
                                    <span class="text hidden-xs hidden-sm text-muted"><?php echo Auth::user()->name; ?></span>
                            ...
                            <ul class="dropdown-menu animated flipInX">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo url('admin/logout') ?>"><i class="fa fa-sign-out"></i>Logout</a></li>
                            </ul>
                            <!--/ End dropdown menu -->
            ...
            <aside id="sidebar-left" class="sidebar-circle">
                ...
                <div id="tour-8" class="sidebar-content">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Hello, <span><?php echo Auth::user()->name; ?></span></h4>
                            <small>Admin</small>
                        </div>
                    </div>
                </div><!-- /.sidebar-content -->
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="../../../production/admin-special/investor/index.html" target="_blank" class="btn btn-block btn-primary">View</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <!-- START @CORE PLUGINS -->
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery/dist/jquery.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery-cookie/jquery.cookie.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/typehead.js/dist/handlebars.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/typehead.js/dist/typeahead.bundle.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery-nicescroll/jquery.nicescroll.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery.sparkline.min/index.js')}}/"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery-easing-original/jquery.easing.1.3.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/ionsound/js/ion.sound.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/bootbox/bootbox.js')}}"></script>
        <!--/ END CORE PLUGINS -->

        <!-- START @PAGE LEVEL PLUGINS -->
<!--        <script src="{{ URL::asset('admin/plugins/bower_components/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/flot/jquery.flot.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/flot/jquery.flot.spline.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/flot/jquery.flot.categories.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/flot/jquery.flot.tooltip.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/flot/jquery.flot.resize.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/flot/jquery.flot.pie.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/dropzone/downloads/dropzone.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery.gritter/js/jquery.gritter.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/skycons-html5/skycons.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/waypoints/lib/jquery.waypoints.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/counter-up/jquery.counterup.min.js')}}"></script>
        <script src="{{ URL::asset('admin/plugins/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js')}}"></script>-->
        <!--/ END PAGE LEVEL PLUGINS -->

        <!-- START @PAGE LEVEL SCRIPTS -->
        <script src="{{ URL::asset('admin/js/apps.js')}}"></script>
        <script src="{{ URL::asset('admin/js/pages/blankon.dashboard.js')}}"></script>
