...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <link href="{{ URL::asset('admin/css/plugins.css')}}" rel="stylesheet">
        <link href="{{ URL::asset('admin/css/themes/default.theme.css')}}" rel="stylesheet" id="theme">
        <link href="{{ URL::asset('admin/css/pages/sign.css')}}" rel="stylesheet">
    ...
    <body class="page-sound">
        ...
        <script src="{{ URL::asset('admin/plugins/bower_components/jquery-validation/dist/jquery.validate.min.js')}}"></script>
        <!--/ END PAGE LEVEL PLUGINS -->

        <!-- START @PAGE LEVEL SCRIPTS -->
        <script src="{{ URL::asset('admin/js/pages/blankon.sign.js')}}"></script>
